...
async def create_analysis(request: AnalysisRequest):
    ...
    analysis_data = AnalysisResponse(
        ...
        emergency=result.emergency_alert or result.risk_assessment.emergency_alert,
        instructions=result.risk_assessment.instructions or (result.health_report.emergency_instructions if result.health_report else None),
